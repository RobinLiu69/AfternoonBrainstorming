...
if TYPE_CHECKING:
    ...
    from rendering.card_renderer import CardRenderer, CardRenderData
...
# def exhibit(page: int, card_renderer: CardRenderer) -> None:
#     for card in all_exhibit_cards[page]:
#         card_renderer.render(card.get_render_data())
