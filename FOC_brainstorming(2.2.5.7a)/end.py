...
def main():
    ...
    if P1matrix == [['角色', '攻擊次數', '造成傷害', '受到傷害次數', '受到傷害', '得分數']] and P2matrix == [['角色', '攻擊次數', '造成傷害', '受到傷害次數', '受到傷害', '得分數']] and TimeLine == []:
        P1matrix = [['角色', '攻擊次數', '造成傷害', '受到傷害次數', '受到傷害', '得分數'], ['SPW', 0, 0, 3, 2, 0], ['TANKR', 0, 0, 13, 19, 29], ['TANKG', 5, 8, 15, 84, 29], ['ADCW', 9, 54, 4, 15, 6], ['LFR', 0, 0, 3, 5, 0], ['ASSP', 9, 22, 4, 8, 9]]
        P2matrix = [['角色', '攻擊次數', '造成傷害', '受到傷害次數', '受到傷害', '得分數'], ['SPG', 3, 7, 6, 6, 22], ['LFR', 5, 42, 14, 37, 17], ['ADCG', 6, 160, 8, 30, 11], ['ASSP', 3, 16, 4, 6, 15], ['ASSW', 7, 39, 2, 2, 18]]
        TimeLine = [0, 1, 0, 1, -1, 0, -2, 0, -3, 0, -3, 1, -3, 2, -3, 1, -4, 0, -5, 0, -4, 0, -4, -1, -4, -1, -4, 0, -3, -2, -5, -3, -5, -3, -6, -3, -6, -3, -6, -3, -7, -3, -5, -1, -3, 2, 0, 5, 2, 6, 5, 10]


    
    threading.Thread(target=makeimg).start()
    waitscreen()
