...
- **方形(TANK)-9/1-小十字**/承受傷害後會獲得一個本回合可使用的移動魔法牌。
...
- **圓形(AP)-2/1(6)-單體最近**/攻擊附帶麻痺並打劫3$，進場則攻擊單體最近2次/+進場改為由可攻擊之隨機友方最近/最遠單位攻擊，目標為本體最近(優先尋找除自己以外的單位)(+1/+2)。
...
- **鑽石(SP)-1/5-單體最遠**/攻擊進入狂暴，並使己方巨人失去自身效果。
